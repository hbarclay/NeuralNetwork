...
#define OPENBLAS_CORE_STEAMROLLER 
#define OPENBLAS_CHAR_CORENAME "STEAMROLLER"
#define OPENBLAS_SLOCAL_BUFFER_SIZE 6144
#define OPENBLAS_DLOCAL_BUFFER_SIZE 5120
#define OPENBLAS_CLOCAL_BUFFER_SIZE 10240
#define OPENBLAS_ZLOCAL_BUFFER_SIZE 10240
